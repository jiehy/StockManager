    ...
    <el-row>
      <el-col :span="8">
        <el-table v-loading="loading" :data="dataList" >
          ...
          <el-table-column label="审核金额" align="center" prop="auditAmount" />
        </el-table>
      </el-col>
      <el-col :span="16">
...
<script>
  import { statMoney} from "@/api/business/report/report";
  ...
  export default {
    ...
    methods: {
      ...
      getList(){
        statMoney(this.queryParams).then(resp=>{
