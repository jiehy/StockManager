...
public class BusBpmnInfo extends BaseEntity
{
    ...
    /** key */
    @Excel(name = "key")
    private String processDefinitio;
    ...
    public void setProcessDefinitio(String processDefinitio) 
    {
        this.processDefinitio = processDefinitio;
    }

    public String getProcessDefinitio() 
    {
        return processDefinitio;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("processDefinitio", getProcessDefinitio())
