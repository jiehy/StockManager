...
public interface BusServiceItemMapper 
{
    ...
    int changeSaleStatus(@Param("id") Long id, @Param("saleStatus") Integer saleStatus);

    int changeAuditStatusById(@Param("id") Long id, @Param("auditStatusReview") Integer auditStatusReview);
}
